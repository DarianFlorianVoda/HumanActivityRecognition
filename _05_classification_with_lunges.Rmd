...
```{r}
#### PAIR PLOT ####
motion_data_box <- data.frame(motion_data_all)
motion_data_box %>% select("Acceleration.X", "Acceleration.Y", "Acceleration.Z", "Orientation.X", "Orientation.Y", "Orientation.Z", "AngularVelocity.X", "AngularVelocity.Y", "AngularVelocity.Z")
...
pairs(motion_data_box %>% select("Acceleration", "Orientation", "AngularVelocity"))

#### CORRELATION PLOT ####
corPlot(motion_data_box %>% select("Acceleration.X", "Acceleration.Y", "Acceleration.Z", "Orientation.X", "Orientation.Y", "Orientation.Z", "AngularVelocity.X", "AngularVelocity.Y", "AngularVelocity.Z"), cl.pos = 'n') 
corPlot(motion_data_box %>% select("Acceleration", "Orientation", "AngularVelocity"))
...
```{r}
categories <- c("Tobias", "Saghar", "Ronaldo", "Regan", "Ahmed")
...
for (i in categories){
  test <- subset(motion_data_all_stat, Author == i & Category == c("Lunge", "Running", "Siu"))
