...
rm( list = ls() )
read_idle = read.csv("/Users/ramin/Downloads/Idle1.csv")
idle_data <- data.frame(read_idle)

read_run = read.csv("/Users/ramin/Downloads/Running1.csv")
run_data <- data.frame(read_run)

read_lunge = read.csv("/Users/ramin/Downloads/Lunges1.csv")
lunge_data <- data.frame(read_lunge)

read_siu = read.csv("/Users/ramin/Downloads/Siu1.csv")
      ...
      tabItem(tabName = "EDA",
              fluidRow(
                ...
                box(
                  ...
                  ,solidHeader = TRUE 
                  ,collapsible = TRUE ,
                  withSpinner(plotlyOutput("Pair_plot", height = 500)))
              ...
              fluidRow(
                ...
                box(
                  ...
                  ,solidHeader = TRUE 
                  ,collapsible = TRUE ,
                  withSpinner(plotOutput("Box_Plot", height = 500))),
